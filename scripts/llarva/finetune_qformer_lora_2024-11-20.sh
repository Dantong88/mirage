...
deepspeed --include $GPU_SETTINGS --master_port=$MASTER_PORT llava/train/train_mem.py \
    ...
    --version llama3 \
    --data_path /home/yuvan/project/vhs_exploration_nov16/close_jar/train_164953.json::/home/yuvan/project/vhs_exploration_nov16/close_jar/val_4148.json \
    --image_folder '' \
    ...
    --bf16 True \
    --output_dir /scratch/one_month/2024_11/niudt/ckpts/11-20-mirage_qformer_ft_lora_60epochs \
    --num_train_epochs 60 \
