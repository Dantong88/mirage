...
export WANDB_NAME='mirage-lora-close_jar_initial_test_ws8_b32_10ep_1e-5_from3ep'

deepspeed --include $GPU_SETTINGS --master_port=$MASTER_PORT llava/train/train_mem.py \
    --lora_enable True --lora_r 128 --lora_alpha 256 --mm_projector_lr 2e-5 \
    --deepspeed ./scripts/zero3.json \
    --model_name_or_path /scratch/partial_datasets/niudt/project/llarva_v2/ckpts/merged/split/llarva-main \
    --version llama3 \
    ...
    --pretrain_mm_mlp_adapter /scratch/partial_datasets/niudt/project/llarva_v2/ckpts/merged/split/llarva-part/mm_projector.pth \
    --pretrain_qformer /scratch/partial_datasets/niudt/project/llarva_v2/ckpts/merged/split/llarva-part/qformer.pth \
